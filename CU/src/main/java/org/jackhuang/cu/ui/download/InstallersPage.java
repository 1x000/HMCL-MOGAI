...
import org.jackhuang.CU.ui.InstallerItem;
import org.jackhuang.CU.ui.construct.MessageDialogPane;
import org.jackhuang.CU.ui.construct.RequiredValidator;
...
public class InstallersPage extends Control implements WizardPage {
    ...
    public InstallersPage(WizardController controller, CUGameRepository repository, String gameVersion, DownloadProvider downloadProvider) {
        ...
        txtName.getValidators().addAll(
                ...
                new Validator(i18n("install.new_game.malformed"), CUGameRepository::isValidVersionId));
