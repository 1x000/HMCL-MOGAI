 ...
 */
package org.jackhuang.CU.ui.download;
...
import org.jackhuang.CU.download.VersionList;
import org.jackhuang.CU.download.fabric.FabricAPIRemoteVersion;
import org.jackhuang.CU.download.fabric.FabricRemoteVersion;
import org.jackhuang.CU.download.forge.ForgeRemoteVersion;
import org.jackhuang.CU.download.game.GameRemoteVersion;
import org.jackhuang.CU.download.liteloader.LiteLoaderRemoteVersion;
import org.jackhuang.CU.download.optifine.OptiFineRemoteVersion;
import org.jackhuang.CU.download.quilt.QuiltAPIRemoteVersion;
import org.jackhuang.CU.download.quilt.QuiltRemoteVersion;
import org.jackhuang.CU.setting.Theme;
import org.jackhuang.CU.setting.VersionIconType;
import org.jackhuang.CU.ui.SVG;
import org.jackhuang.CU.ui.animation.ContainerAnimations;
import org.jackhuang.CU.ui.animation.TransitionPane;
import org.jackhuang.CU.ui.construct.ComponentList;
import org.jackhuang.CU.ui.construct.HintPane;
import org.jackhuang.CU.ui.construct.IconedTwoLineListItem;
import org.jackhuang.CU.ui.construct.RipplerContainer;
import org.jackhuang.CU.ui.wizard.Navigation;
import org.jackhuang.CU.ui.wizard.Refreshable;
import org.jackhuang.CU.ui.wizard.WizardPage;
import org.jackhuang.CU.util.CUService;
import org.jackhuang.CU.util.Holder;
import org.jackhuang.CU.util.i18n.Locales;
...
import static org.jackhuang.CU.ui.ToolbarListPageSkin.wrap;
...
public final class VersionsPage extends BorderPane implements WizardPage, Refreshable {
    ...
    public void refresh() {
        ...
        executor = currentVersionList.refreshAsync(gameVersion).whenComplete((result, exception) -> {
            ...
            // https://github.com/huanghongxun/CU/issues/938
            System.gc();
        });
    }
    ...
    private void onSponsor() {
        CUService.openRedirectLink("bmclapi_sponsor");
    }
