 ...
 */
package org.jackhuang.CU.ui.export;
...
import static org.jackhuang.CU.ui.FXUtils.jfxListCellFactory;
import static org.jackhuang.CU.ui.FXUtils.stringConverter;
import static org.jackhuang.CU.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE;
import static org.jackhuang.CU.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_SERVER;
...
public final class ModpackInfoPage extends Control implements WizardPage {
    ...
    private final CUGameRepository gameRepository;
    ...
    public ModpackInfoPage(WizardController controller, CUGameRepository gameRepository, String version) {
...

            {
                ...
                if (skinnable.controller.getSettings().get(MODPACK_TYPE) == MODPACK_TYPE_SERVER) {
                    ...
                    hyperlink.setOnMouseClicked(e -> {
                        FXUtils.openLink("https://CU.huangyuhui.net/api/redirect/server-modpack");
                    });
