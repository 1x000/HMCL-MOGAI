 ...
 */
package org.jackhuang.CU.ui.main;

import javafx.beans.property.ReadOnlyObjectProperty;
import org.jackhuang.CU.event.EventBus;
import org.jackhuang.CU.event.RefreshedVersionsEvent;
import org.jackhuang.CU.game.CUGameRepository;
import org.jackhuang.CU.game.ModpackHelper;
import org.jackhuang.CU.game.Version;
import org.jackhuang.CU.setting.Accounts;
import org.jackhuang.CU.setting.Profile;
import org.jackhuang.CU.setting.Profiles;
...
import org.jackhuang.CU.ui.account.AccountAdvancedListItem;
import org.jackhuang.CU.ui.construct.AdvancedListBox;
import org.jackhuang.CU.ui.construct.AdvancedListItem;
import org.jackhuang.CU.ui.construct.JFXHyperlink;
import org.jackhuang.CU.ui.construct.MessageDialogPane;
import org.jackhuang.CU.ui.decorator.DecoratorAnimatedPage;
import org.jackhuang.CU.ui.decorator.DecoratorPage;
import org.jackhuang.CU.ui.download.ModpackInstallWizardProvider;
import org.jackhuang.CU.ui.versions.GameAdvancedListItem;
import org.jackhuang.CU.ui.versions.Versions;
import org.jackhuang.CU.upgrade.UpdateChecker;
import org.jackhuang.CU.util.TaskCancellationAction;
...
import static org.jackhuang.CU.ui.versions.VersionPage.wrap;
...
public class RootPage extends DecoratorAnimatedPage implements DecoratorPage {
    ...
    public RootPage() {
        EventBus.EVENT_BUS.channel(RefreshedVersionsEvent.class)
                .register(event -> onRefreshedVersions((CUGameRepository) event.getSource()));
    ...
    private static class Skin extends DecoratorAnimatedPageSkin<RootPage> {
        ...
        protected Skin(RootPage control) {
            ...
            link.setExternalLink("https://CU.huangyuhui.net/api/redirect/multiplayer-migrate");
    ...
    private void onRefreshedVersions(CUGameRepository repository) {
        runInFX(() -> {
            if (!checkedModpack) {
                checkedModpack = true;
