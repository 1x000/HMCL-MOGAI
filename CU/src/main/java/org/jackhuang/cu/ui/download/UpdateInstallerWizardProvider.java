...
import org.jackhuang.CU.download.game.GameAssetIndexDownloadTask;
import org.jackhuang.CU.download.game.LibraryDownloadException;
...
import org.jackhuang.CU.task.DownloadException;
    ...
    public Object finish(Map<String, Object> settings) {
        ...
        for (Object value : settings.values()) {
            if (value instanceof RemoteVersion) {
                ...
                stages.add(String.format("CU.install.%s:%s", remoteVersion.getLibraryId(), remoteVersion.getSelfVersion()));
                if ("game".equals(remoteVersion.getLibraryId())) {
                    stages.add("CU.install.assets");
                }
