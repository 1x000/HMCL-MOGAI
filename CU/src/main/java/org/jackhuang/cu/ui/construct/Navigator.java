...
import org.jackhuang.CU.ui.animation.AnimationProducer;
...
public class Navigator extends TransitionPane {
    ...
    public void navigate(Node node, AnimationProducer animationProducer) {
        ...
        node.getProperties().put("CU.navigator.animation", animationProducer);
    ...
    public void close(Node from) {
        ...
        Object obj = from.getProperties().get("CU.navigator.animation");
