...
public class AboutPage extends StackPane {
    ...
    public AboutPage() {
        ComponentList about = new ComponentList();
        {
            ...
            launcher.setExternalLink("https://CU.huangyuhui.net");
        ...
        ComponentList thanks = new ComponentList();
        {
            ...
            contributors.setExternalLink("https://github.com/huanghongxun/CU/graphs/contributors");
            ...
            users.setExternalLink("https://CU.huangyuhui.net/api/redirect/sponsor");
        ...
        ComponentList legal = new ComponentList();
        {
            ...
            copyright.setExternalLink("https://CU.huangyuhui.net/about/");
            ...
            openSource.setExternalLink("https://github.com/huanghongxun/CU");
