...
class AdditionalInstallersPage extends InstallersPage {
    ...
    public AdditionalInstallersPage(String gameVersion, Version version, WizardController controller, CUGameRepository repository, DownloadProvider downloadProvider) {
