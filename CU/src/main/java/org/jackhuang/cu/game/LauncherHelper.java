...
import org.jackhuang.CU.auth.*;
import org.jackhuang.CU.auth.authlibinjector.AuthlibInjectorDownloadException;
import org.jackhuang.CU.download.DefaultDependencyManager;
import org.jackhuang.CU.download.DownloadProvider;
import org.jackhuang.CU.download.LibraryAnalyzer;
import org.jackhuang.CU.download.MaintainTask;
import org.jackhuang.CU.download.game.*;
import org.jackhuang.CU.download.java.JavaRepository;
import org.jackhuang.CU.launch.*;
import org.jackhuang.CU.mod.ModpackCompletionException;
import org.jackhuang.CU.mod.ModpackConfiguration;
import org.jackhuang.CU.mod.ModpackProvider;
import org.jackhuang.CU.setting.*;
import org.jackhuang.CU.task.*;
import org.jackhuang.CU.ui.*;
import org.jackhuang.CU.ui.construct.*;
import org.jackhuang.CU.ui.construct.MessageDialogPane.MessageType;
import org.jackhuang.CU.util.*;
import org.jackhuang.CU.util.i18n.I18n;
import org.jackhuang.CU.util.io.ResponseCodeException;
import org.jackhuang.CU.util.platform.*;
import org.jackhuang.CU.util.versioning.VersionNumber;
...
import static org.jackhuang.CU.util.Lang.resolveException;
...
public final class LauncherHelper {
    ...
    private void launch0() {
        CUGameRepository repository = profile.getRepository();
                ...
                .thenComposeAsync(authInfo -> Task.supplyAsync(() -> {
                    ...
                    return new CUGameLauncher(
                            ...
                            launcherVisibility == LauncherVisibility.CLOSE
                                    ...
                                    : new CUProcessListener(repository, version.get(), authInfo, launchOptions, launchingLatch, gameVersion.isPresent())
                    );
        ...
        return Task.composeAsync(() -> {
            ...
            if (javaVersion == null) {
                ...
                if (setting.isJavaAutoSelected()) {
                    ...
                    if (org.jackhuang.CU.util.platform.Platform.isCompatibleWithX86Java()) {
            ...
            if (violatedSuggestedConstraints != null) {
                for (JavaVersionConstraint violatedSuggestedConstraint : violatedSuggestedConstraints) {
                    switch (violatedSuggestedConstraint) {
                        ...
                        case VANILLA_X86:
                            if (setting.getNativesDirType() == NativesDirectoryType.VERSION_FOLDER
                                    && org.jackhuang.CU.util.platform.Platform.isCompatibleWithX86Java()) {
     ...
     * Guarantee that one [JavaProcess], one [CUProcessListener].
     * Because every time we launched a game, we generates a new [CUProcessListener]
     */
    private final class CUProcessListener implements ProcessListener {

        private final CUGameRepository repository;
        ...
        public CUProcessListener(CUGameRepository repository, Version version, AuthInfo authInfo, LaunchOptions launchOptions, CountDownLatch launchingLatch, boolean detectWindow) {
