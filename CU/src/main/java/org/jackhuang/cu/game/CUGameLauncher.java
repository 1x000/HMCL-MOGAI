...
import org.jackhuang.CU.auth.AuthInfo;
import org.jackhuang.CU.launch.DefaultLauncher;
import org.jackhuang.CU.launch.ProcessListener;
import org.jackhuang.CU.util.Logging;
import org.jackhuang.CU.util.i18n.I18n;
import org.jackhuang.CU.util.io.FileUtils;
import org.jackhuang.CU.util.platform.ManagedProcess;
 ...
 * @author huangyuhui
 */
public final class CUGameLauncher extends DefaultLauncher {

    public CUGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options) {
        this(repository, version, authInfo, options, null);
    }

    public CUGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options, ProcessListener listener) {
        this(repository, version, authInfo, options, listener, true);
    }

    public CUGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options, ProcessListener listener, boolean daemon) {
