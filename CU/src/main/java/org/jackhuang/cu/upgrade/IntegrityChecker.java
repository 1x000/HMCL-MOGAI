...
/**
 * A class that checks the integrity of CU.
 *
 * @author yushijinhun
 */
public final class IntegrityChecker {
    ...
    private static final String SIGNATURE_FILE = "META-INF/CU_signature";
    private static final String PUBLIC_KEY_FILE = "assets/CU_signature_publickey.der";
    ...
    private static void verifySelf() throws IOException {
        Path self = JarUtils.thisJar().orElseThrow(() -> new IOException("Failed to find current CU location"));
