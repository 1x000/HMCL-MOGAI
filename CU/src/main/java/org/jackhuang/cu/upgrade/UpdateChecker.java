...
import static org.jackhuang.CU.util.versioning.VersionNumber.asVersion;
...
public final class UpdateChecker {
    ...
    private static RemoteVersion checkUpdate(UpdateChannel channel) throws IOException {
        if (!IntegrityChecker.isSelfVerified() && !"true".equals(System.getProperty("CU.self_integrity_check.disable"))) {
