...
import org.jackhuang.CU.ui.AwtUtils;
import org.jackhuang.CU.util.FractureiserDetector;
import org.jackhuang.CU.util.Logging;
import org.jackhuang.CU.util.SelfDependencyPatcher;
...
public final class Main {
    ...
    public static void main(String[] args) {
        ...
        System.getProperties().putIfAbsent("http.agent", "CU/" + Metadata.VERSION);
        ...
        Logging.start(Metadata.CU_DIRECTORY.resolve("logs"));
    ...
    private static void checkDirectoryPath() {
        ...
        if (currentDirectory.contains("!")) {
            ...
            showErrorAndExit("Exclamation mark(!) is not allowed in the path where CU is in.\n"
