...
import org.jackhuang.CU.setting.SambaException;
import org.jackhuang.CU.task.AsyncTaskExecutor;
...
import org.jackhuang.CU.util.CrashReporter;
...
public final class Launcher extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            if (Metadata.CU_DIRECTORY.toString().indexOf('=') >= 0) {
    ...
    private static void checkConfigOwner() {
        ...
        if (Files.exists(Metadata.CU_DIRECTORY))
            files.add(Metadata.CU_DIRECTORY.toString());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("CU Directory: " + Metadata.CU_DIRECTORY);
            LOG.info("CU Jar Path: " + JarUtils.thisJar().map(it -> it.toAbsolutePath().toString()).orElse("Not Found"));
