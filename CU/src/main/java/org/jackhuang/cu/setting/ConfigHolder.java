...
public final class ConfigHolder {
    ...
    public static final String CONFIG_FILENAME = "CU.json";
    public static final String CONFIG_FILENAME_LINUX = ".CU.json";
    public static final Path GLOBAL_CONFIG_PATH = Metadata.CU_DIRECTORY.resolve("config.json");
