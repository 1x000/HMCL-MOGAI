...
import org.jackhuang.CU.event.EventPriority;
import org.jackhuang.CU.event.RefreshedVersionsEvent;
import org.jackhuang.CU.game.CUCacheRepository;
...
import org.jackhuang.CU.util.javafx.ObservableHelper;
...
public final class Profile implements Observable {
    ...
    public Profile(String name, File initialGameDir, VersionSetting global, String selectedVersion, boolean useRelativePath) {
        ...
        repository = new CUGameRepository(this, initialGameDir);
    ...
    public CUGameRepository getRepository() {
        return repository;
    }
    ...
    public DefaultDependencyManager getDependency(DownloadProvider downloadProvider) {
        return new DefaultDependencyManager(repository, downloadProvider, CUCacheRepository.REPOSITORY);
    }
