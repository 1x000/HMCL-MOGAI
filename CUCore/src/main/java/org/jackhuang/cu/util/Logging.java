...
public final class Logging {
    ...
    public static final Logger LOG = Logger.getLogger("CU");
    ...
    public static void start(Path logFolder) {
        ...
        try {
            ...
            FileHandler fileHandler = new FileHandler(logFolder.resolve("CU.log").toAbsolutePath().toString());
            fileHandler.setLevel(Level.FINEST);
            fileHandler.setFormatter(DefaultFormatter.INSTANCE);
            fileHandler.setEncoding("UTF-8");
            LOG.addHandler(fileHandler);
        } catch (IOException e) {
            System.err.println("Unable to create CU.log\n" + StringUtils.getStackTrace(e));
        }
