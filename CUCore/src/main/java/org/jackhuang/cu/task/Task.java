...
import org.jackhuang.CU.util.ReflectionHelper;
...
import org.jackhuang.CU.util.function.ExceptionalSupplier;
...
public abstract class Task<T> {
    ...
    private static String getCaller() {
        return ReflectionHelper.getCaller(packageName -> !"org.jackhuang.CU.task".equals(packageName)).toString();
    }
