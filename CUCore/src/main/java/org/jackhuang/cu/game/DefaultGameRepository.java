...
import org.jackhuang.CU.download.game.VersionJsonSaveTask;
import org.jackhuang.CU.event.Event;
import org.jackhuang.CU.event.EventBus;
import org.jackhuang.CU.event.GameJsonParseFailedEvent;
import org.jackhuang.CU.event.LoadedOneVersionEvent;
import org.jackhuang.CU.event.RefreshedVersionsEvent;
import org.jackhuang.CU.event.RefreshingVersionsEvent;
import org.jackhuang.CU.event.RemoveVersionEvent;
import org.jackhuang.CU.event.RenameVersionEvent;
import org.jackhuang.CU.game.tlauncher.TLauncherVersion;
import org.jackhuang.CU.mod.ModManager;
...
import org.jackhuang.CU.util.platform.Platform;
...
public class DefaultGameRepository implements GameRepository {
    ...
    public boolean removeVersionFromDisk(String id) {
        ...
        try {
            ...
            // remove json files first to ensure CU will not recognize this folder as a valid version.
