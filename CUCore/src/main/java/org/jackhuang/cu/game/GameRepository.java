 ...
 * see {@link org.jackhuang.CU.download.DependencyManager}
 *
 * @author huangyuhui
 */
public interface GameRepository extends VersionProvider {
     ...
     * Or if it returns a temporary directory, {@link org.jackhuang.CU.launch.Launcher#makeLaunchScript} will fail.
     * If you do want to return a temporary directory, make {@link org.jackhuang.CU.launch.Launcher#makeLaunchScript}
