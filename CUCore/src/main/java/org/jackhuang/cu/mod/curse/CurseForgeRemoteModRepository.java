...
import org.jackhuang.CU.util.MurmurHash2;
...
public final class CurseForgeRemoteModRepository implements RemoteModRepository {
    ...
    private static final String apiKey = System.getProperty("CU.curseforge.apikey", JarUtils.getManifestAttribute("CurseForge-Api-Key", ""));
