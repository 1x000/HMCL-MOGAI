...
import org.jackhuang.CU.mod.curse.CurseMetaMod;
...
import static org.jackhuang.CU.util.Lang.wrap;
import static org.jackhuang.CU.util.Lang.wrapConsumer;
                            ...
                            if (file instanceof McbbsModpackManifest.CurseFile) {
                                ...
                                if (StringUtils.isNotBlank(curseFile.getFileName())) {
                                    if (!modManager.hasSimpleMod(curseFile.getFileName())) {
                                        ...
                                        dependencies.add(task.withCounter("CU.modpack.download"));
                                    }
                                }
                            }
