package org.jackhuang.CU.util.skin;
...
public class NormalizedSkinTest {
    private static NormalizedSkin getSkin(String name) throws InvalidSkinException {
        String path = Paths.get("../CU/src/main/resources/assets/img/skin/" + name + ".png").normalize().toAbsolutePath().toUri().toString();
        return new NormalizedSkin(new Image(path));
    }

    @Test
    @EnabledIf("org.jackhuang.CU.JavaFXLauncher#isStarted")
